...
(
  ...
  git clone https://github.com/hsuna/jd-scripts-docker.git /jd-scripts-docker_tmp
...
(
  ...
  git clone --branch=master https://gitee.com/hsuna/jd_scripts.git /scripts_tmp
  [ -d /scripts_tmp ] && {
    rm -rf /scripts
...
(
  ...
  git clone --branch=main https://gitee.com/hsuna/Loon.git /loon_tmp
  [ -d /loon_tmp ] && {
    rm -rf /loon
    mv /loon_tmp /loon
  }
